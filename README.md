...
Design Process:
We had a tight budget of about $100 for materials and a two-week timeline to get the whole thing built and working. That meant being deliberate about every part we used, since there wasn't room to over-order or waste anything. The 3D-printed flow straighteners took a good amount of trial and error to get right, since there were a lot of fine details to render correctly for the print to actually straighten the airflow the way it needed to. Below is an example of the different terminologies that we used and can show a rough image of what we are talking about.

![Example](Wind_Tunnel_Example.jpg)
